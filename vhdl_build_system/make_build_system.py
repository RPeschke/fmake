...
def make_build_wrap(x):
    ...
    save_file("build/vhdl_csv_io/text_io_export_csv.vhd",  csv_io.text_io_export_csv)
    ...
    save_file("build/vhdl_csv_io/text_io_import_csv.vhd",  csv_io.text_io_import_csv)
